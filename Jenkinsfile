pipeline {
  ...
  environment {
    ...
    NAMESPACE = "@eeacms"
    SONARQUBE_TAGS = "volto.eea.europa.eu,demo-www.eea.europa.eu,www.eea.europa.eu-en,climate-adapt.eea.europa.eu,water.europa.eu-freshwater,insitu.copernicus.eu"
    DEPENDENCIES = ""
